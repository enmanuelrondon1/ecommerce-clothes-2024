...
export const Footer = () => {
  ...
  <footer data-aos="fade-up " className="bg-gray-100 dark:bg-gray-600 py-10 dark:text-white">
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      <div data-aos="fade-up" className="lg:flex lg:items-start lg:gap-8">
      ...
      <div className="mt-8 border-t border-gray-100 pt-8">
        <div className="sm:flex sm:justify-between">
          <p className="text-md text-gray-500">&copy;  2023 Shopsy. All rights reserved.</p>
          <div className="mt-10 flex justify-center">
         
        </div>
  
          <ul className="mt-8 flex flex-wrap justify-start gap-4 text-md sm:mt-0 lg:justify-end">
            <li>
